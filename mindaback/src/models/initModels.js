...
// CNG cylinder process — register the cng_* models on the sequelize instance so
// sync()/migrations create them. New + additive; no associations into MINDA tables.
import "./cng.model.js";
// SAP integration — register the sap_* models (additive; no MINDA associations).
import "./sap.model.js";
// Teammate's SAP integration: material master cache + outbound-sync outbox + enqueue hooks (additive).
import { SapMaterialModel } from "./sapMaterial.model.js";
import { SapSyncOutboxModel } from "./sapSyncOutbox.model.js";
import { registerTemplateSyncHooks } from "../services/templateSyncHooks.js";
...
export const initModels = () => {
    ...
    // Teammate's outbound template->SAP sync hooks (enqueue into sap_sync_outbox on template/field/submission writes).
    registerTemplateSyncHooks();
